...
*   **Deployment:** `zrok share public backend:4180 --backend-mode proxy --oauth google` (Zrok natively supports OAuth fronts).
*   **Benefit:** Highly isolated from the core Tailnet. Extremely fast to spin up via Docker sidecars.
